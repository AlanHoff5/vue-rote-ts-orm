...
class ClienteController {
    ...
    async list(req: Request, res: Response) {
        const repository = getRepository(Cliente); //Foi importado do typeorm
        const lista = await repository.createQueryBuilder('tb_cliente').leftJoinAndSelect("tb_cliente.veiculo", "veiculo").innerJoinAndSelect("tb_cliente.endereco", "endereco").getMany();
    ...
    async store(req: Request, res: Response) {
        const repository = getRepository(Cliente);//recupera o repositorio de Endereço
    ...
    async delete(req: Request, res: Response) {
        ...
        const repository = getRepository(Cliente);//recupera o repositorio do Pessoa.

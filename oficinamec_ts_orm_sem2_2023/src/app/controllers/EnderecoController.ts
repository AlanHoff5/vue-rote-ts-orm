...
class EnderecoController {
    ...
    //metodos para inserção, alteração e remoção de Endereco
    ...
    async delete(req: Request, res: Response) {
        ...
        const repository = getRepository(Endereco);//recupera o repositorio do Pessoa.
    ...
    async update(req: Request, res: Response) {
        ...
        const repository = getRepository(Endereco);//recupera o repositorio do Cliente.
        ...
        const e = repository.create(req.body); //cria a entidade Cliente
